    ...
    <!-- content start -->
        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">待处理人员</strong> / <small>还有以下人员</small><input type="hidden" value="<s:property value="ausername"/>"></div>
            </div>
            <div class="am-g">
											...
											<div class="modal fade" id="myModal<s:property value="#sb.tel"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
											  <div class="modal-dialog">
											    <div class="modal-content">
											      ...
											      <form action="adminchulido.roah" method="post" onsubmit="return sure()">

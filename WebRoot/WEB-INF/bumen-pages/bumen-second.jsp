    ...
    <!-- content start -->
        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">第二志愿</strong> / <small>对我们还有意向</small><input type="hidden" value="<s:property value="ausername"/>"></div>
            </div>
            <div class="am-g">
                    ...
                    <div class="am-panel am-panel-default">
                        ...
                        <div class="am-u-sm-12">
                            <table class="am-table am-table-bd am-table-striped admin-content-table">
                                ...
                                <s:if test="#sb.bumen_1==ausername">
											  ...
											  <div class="modal-dialog">
											    <div class="modal-content">
											      ...
											      <div class="modal-body">
						                             ...
						                             <br>面试官评价<br>
						                             <textarea class="form-control" rows="3" name="apingjia"><s:property value="#sb.pingjia_1"/></textarea>

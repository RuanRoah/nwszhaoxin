...
<![endif]-->
    <!-- content start -->
        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">报名人员</strong> / <small>可能是我未来的的部员</small><input type="hidden" value="<s:property value="ausername"/>"></div>
            </div>
            <div class="am-g">
											    ...
											    <div class="modal-content">
											      ...
											      <form action="bumenqueding.roah" method="post" onsubmit="return sure()">
						                             ...
						                             <select name="azhuangtai" class="form-control">
													  ...
													  参考评价1:<s:property value="#sb.pingjia_1"/>
													 <br>参考评价2:<s:property value="#sb.pingjia_2"/>
													 <br>
						                             <br>面试官评价<br>
						                             <textarea class="form-control" rows="3" name="apingjia"><s:property value="#sb.pingjiamain"/></textarea>
    ...
    <script type="text/javascript">
    	function sure()
    	{
    	   if(window.confirm('你确定评价和更改状态了吗？')){
                 //alert("确定");
                 return true;
              }else{
                 //alert("取消");
